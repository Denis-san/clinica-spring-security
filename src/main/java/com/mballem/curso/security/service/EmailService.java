...
public class EmailService {
	...
	public void enviarPedidoDeConfirmacaoDeCadastro(String destino, String codigo) throws MessagingException, MailSendException {
	...
	public void enviarPedidoRedefinicaoDeSenha(String destino, String codigoVerificador) throws MessagingException, MailSendException {
		MimeMessage message = mailSender.createMimeMessage();
		MimeMessageHelper helper = new MimeMessageHelper(message, MimeMessageHelper.MULTIPART_MODE_MIXED_RELATED, "UTF-8");
